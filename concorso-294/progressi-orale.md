# Progressi — preparazione orale RIPAM 294

Prova: **venerdì 27 novembre 2026**. Soglia 21/30.

---

## Sessione 1 — Econometria — «I modelli econometrici» — 21 settembre 2026

**Copertura**: manuale Parte III, Capitolo 6, pp. 330-344 (dispensa 05 §25-31)

**Come è andata.** Primo giorno di una materia mai affrontata. Le prime due
risposte sono state tirate a indovinare; il quadro si è sbloccato solo dopo
aver messo sotto le parole un esempio concreto (la funzione keynesiana del
consumo). Da lì le ultime due risposte sono state ragionate, non ricordate.

| Domanda | Esito |
|---|---|
| In che cosa l'econometria si distingue dalla statistica (ripetibilità) | ❌ da rifare |
| Che cosa sono i dati panel e i tre vantaggi | — non affrontata |
| Endogena ed esogena in C = a₀ + a₁Y | ❌ invertite |
| Endogena ed esogena in I = b₀ + b₁r | ✅ corretta e ragionata |

**Da riprendere**
- **La ripetibilità** — perché probabilità e statistica la richiedono e i dati
  economici non ce l'hanno. Richiedere fra tre giorni.
- I **tre vantaggi del panel** (§1.4), mai toccati.
- **Forma strutturale e ridotta** (§4), mai toccata.

**La frase del giorno** — non costruita: sessione chiusa prima, per non
sovraccaricare. Da recuperare alla sessione 2.
...
assegnato quindici pagine di teoria e poi interrogato a livello d'orale: non
ha prodotto nulla finché non è comparso un esempio concreto.

**Da qui in avanti l'ordine è: esempio → lettura del manuale → interrogazione.**
L'aggancio concreto va piantato PRIMA di assegnare le pagine, così la lettura
avviene con qualcosa a cui appendere le parole.

**Calibrare l'asticella sul giorno.** Alla prima sessione di una materia nuova
l'obiettivo non è la risposta da orale: è prendere un appiglio. Il livello
d'esame si pretende dalla terza o quarta sessione in poi.
